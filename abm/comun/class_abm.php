...
class class_abm{
	...
	public $textoPreguntarBorrar = "¿Seguro que desea borrar el elemento seleccionado?";
	...
	public $jsIniciadorCamposFecha = "new DatePicker($('%s'), { pickerClass: 'datepicker_vista' });";
        ...
        public $jsIniciadorCamposHora = "new DatePicker($('%s'), { pickerClass: 'datepicker_vista', timePickerOnly:'true', inputOutputFormat:'h:m', format:'h:m' });";
	
        public $jsIniciadorCampoColor = "";
				...
				case "pass":
					echo "<script type='text/javascript'>
                                                function verificar_contrasenia(){
                                                    if ( document.getElementById('".$campo[campo]."') == document.getElementById('".$campo[campo]."_R')  )
                                                        return = true
                                                    else
                                                        return = false
                                                }                                                
					...
					echo "<input type='password' name='".$campo[campo]."'   id='".$campo[campo]."'      value='".($_POST[$campo[campo]] != "" ? $_POST[$campo[campo]] : $campo[valorPredefinido])."' ".($campo[maxLen]>0 ? "maxlength='$campo[maxLen]'" : "")." class='input-pass $requerido' $campo[adicionalInput]  onblur='verificar_contrasenia();' /> \n";                                        
					//echo "<input type='password' name='".$campo[campo]."_R' id='".$campo[campo].'_R'."' value='".($_POST[$campo[campo]] != "" ? $_POST[$campo[campo]] : $campo[valorPredefinido])."' ".($campo[maxLen]>0 ? "maxlength='$campo[maxLen]'" : "")." class='input-pass $requerido' $campo[adicionalInput] onclick='verificar_contrasenia();' /> \n";
                                        break;
