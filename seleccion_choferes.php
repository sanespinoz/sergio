...
$id_chofer = $_REQUEST["code"]; // patente del vehiculo seleccionado.
$id_guarda = $_REQUEST["code2"]; // patente del vehiculo seleccionado.
...
$sql = "SELECT u.id, u.usuario, u.nombre, u.apellido, u.dni, u.fecha_tecnica 
        FROM usuarios AS u  
        WHERE u.id_tipo_usuario =  '3' and u.activo='1'";
